...
# ==========================================
# ★ Glassmorphism 커스텀 CSS (라이트 모드 충돌 완벽 방어 및 UI 개편 적용)
# ==========================================
glassmorphism_css = """
<style>
.stApp {
...
# -------------------------------------------------------------------------
with col_main:
    # Big 탭 (가로 라디오 버튼으로 탭 UI 구현)
    big_tab = st.radio(
        "메인 메뉴",
        ["1. ETF 시장 모니터링", "2. KODEX 리밸런싱 시뮬레이션", "3. 글로벌 상품 기획 시뮬레이터", "🤖 AI 프롬프트"],
        horizontal=True,
        label_visibility="collapsed"
    )
    
    st.markdown("<br>", unsafe_allow_html=True) # 탭과 콘텐츠 사이 간격
    ...
    # =========================================================================
    # Big 탭 2: KODEX 리밸런싱 시뮬레이션
    # =========================================================================
    elif big_tab == "2. KODEX 리밸런싱 시뮬레이션":
    ...
    # =========================================================================
    # Big 탭 3: 글로벌 상품 기획 시뮬레이터
    # =========================================================================
    elif big_tab == "3. 글로벌 상품 기획 시뮬레이터":
...
"""
    ...
    # =========================================================================
        ...
        df_volume_summary_text = st.session_state.df_volume_summary_text
        aum_context_text = st.session_state.aum_context_text
        media_context = st.session_state.media_context
