...
def parse_competitor_blog(blog_id):
    ...
    events, generals = [], []
    whitelist_promo = ['인증', '퀴즈', '경품', '이벤트', '프로모션', '스타벅스', '쿠폰', '추첨']
    whitelist_seminar = ['세미나', '웨비나', 'live', '라이브', '간담회']
    try:
...
with col_main:
    ...
    if big_tab == "1. ETF 시장 모니터링":
        ...
        # === Small Tab 5 (100% 원본 복구: 11개 운용사 리스트) ===
        with sub_tabs[5]:
    ...
    # =========================================================================
    # Big 탭 2: 글로벌 상품 기획 시뮬레이터 (원본 100% 복구 + 3분할 탭 적용)
    # =========================================================================
